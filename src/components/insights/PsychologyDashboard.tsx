  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Discipline Index */}
        <div className="bg-surface border border-default p-6 rounded-2xl flex flex-col items-center justify-center text-center shadow-xl">
        ...
        <div className="bg-surface border border-default p-6 rounded-2xl lg:col-span-2 shadow-xl flex flex-col justify-between">
          <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Prescriptions */}
        <div className="bg-surface border border-default p-6 rounded-2xl shadow-xl">
          <h3 className="text-sm font-bold text-secondary uppercase tracking-widest mb-6 flex items-center gap-2">
            <i className="las la-capsules text-blue-500 text-lg"></i> AI Actionable Prescriptions
          </h3>
          <ul className="space-y-4">
            {prescriptions.map((px, i) => (
              <li key={i} className="flex items-start gap-3 bg-elevated p-4 rounded-xl border border-default">
