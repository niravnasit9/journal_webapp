  ...
  return (
    <div className="premium-card w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Target Progress */}
        <div className="premium-inner-box p-5 lg:col-span-2">
        ...
        {/* Consistency Auditor */}
        <div className="premium-inner-box p-5 flex flex-col justify-between">
          <div>
            <span className="label-premium mb-3 flex items-center justify-between">
              Consistency Rule
              {consistencyPass ? (
