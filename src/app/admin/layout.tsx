...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!user.emailVerified) {
    return (
      <div className="min-h-screen bg-[#fafafa] dark:bg-[#0a0f1c] flex flex-col items-center justify-center text-gray-900 dark:text-white p-6 font-sans transition-colors duration-300">
        <div className="max-w-md w-full bg-white dark:bg-[#111318] rounded-[24px] p-8 border-2 border-indigo-500/20 shadow-2xl text-center">
          ...
          <p className="text-gray-500 dark:text-slate-400 mb-8 font-medium">
            ...
            Please verify your email address to access the admin panel.
          </p>
