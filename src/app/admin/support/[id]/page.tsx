  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 font-sans max-w-4xl mx-auto pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 bg-white dark:bg-[#0f1115] border-b border-gray-200 dark:border-transparent p-6 transition-colors duration-300 rounded-b-2xl shadow-sm">
        <div>
          <Link href="/admin/support" className="text-sm font-bold text-secondary hover:text-gray-900 dark:hover:text-primary transition-colors mb-2 inline-flex items-center gap-1">
        ...
        {ticket.status === "open" && (
          <button 
            ...
            disabled={isClosing}
            className="px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-gray-900 dark:text-primary text-sm font-bold rounded-lg transition-colors flex items-center gap-2 shrink-0"
          >
