  ...
  return (
    <div className="space-y-6 animate-in fade-in font-sans">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-neutral-400 mt-1">Manage user inquiries and technical support requests.</p>
      </div>
          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
            ...
            <tbody className="divide-y divide-neutral-800">
              {loading ? (
                ...
                <tr><td colSpan={6} className="px-6 py-12 text-center text-neutral-500 font-bold">No tickets match your criteria.</td></tr>
              ) : (
                filteredTickets.map(t => (
                  <tr key={t.id} className="hover:bg-[#121212]/50 transition-colors">
                    <td className="px-6 py-4 font-mono text-xs text-neutral-500">#{t.id.substring(0,8)}</td>
                    ...
                    <td className="px-6 py-4">
                      {t.status === "open" 
                        ...
                        : <span className="bg-neutral-800 text-neutral-500 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest">Closed</span>
                      }
                    </td>
      ...
      {isModalOpen && selectedTicket && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="premium-card w-full max-w-2xl p-0 shadow-2xl animate-in zoom-in-95 border border-neutral-800 overflow-hidden flex flex-col max-h-[85vh]">
            
            <div className="p-6 border-b border-neutral-800 bg-[#121212] flex justify-between items-start">
              <div>
            ...
            <div className="p-6 flex-1 overflow-y-auto space-y-4 bg-black/50">
              {messages.length === 0 ? (
                <div className="text-center text-neutral-500 italic py-12">No messages found.</div>
              ) : (
                messages.map(m => (
              ...
              {selectedTicket.status === "open" ? (
                <div className="space-y-4">
                  <textarea 
                    ...
                    className="input-premium w-full bg-black border-neutral-800 h-24 resize-none"
                  ></textarea>
